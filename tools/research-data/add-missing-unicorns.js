#!/usr/bin/env node
/**
 * Add missing BC AI companies to database
 */
...
async function addMissingCompanies() {
  console.log('🚀 Adding missing BC AI companies to database...\n');
  ...
  const companies = [
    {
      ...
      properties: {
        ...
        'Twitter': { rich_text: [{ text: { content: '@trulioo' } }] },
        ...
        'Focus & Notes': {
          rich_text: [{
            text: {
              content: 'Series D: $394M (2021) | Valuation: $1.75B (Unicorn) | Total raised: $476M+ | 501-1000 employees | Backed by TCV, Goldman Sachs, Citi Ventures | 15K LinkedIn followers'
            }
          }]
        },
        'AI Focus Areas': {
    ...
    },
    {
      ...
      properties: {
        ...
        'Twitter': { rich_text: [{ text: { content: '@thinkific' } }] },
        'Category': { select: { name: 'AI Companies' } },
        'City/Region': { rich_text: [{ text: { content: 'Vancouver' } }] },
        'BC Region': { select: { name: 'Lower Mainland' } },
        ...
        'Focus & Notes': {
          rich_text: [{
            text: {
              content: 'Public company (TSX: THNC) | IPO 2021 | Market cap ~$150M CAD | 201-500 employees | Online course platform | 25K LinkedIn followers'
            }
          }]
        },
        'AI Focus Areas': {
    ...
    },
    {
      ...
      properties: {
        'Name': { title: [{ text: { content: 'Minerva Intelligence' } }] },
        'Website': { url: 'https://minervaintelligence.com' },
        'LinkedIn': { url: 'https://www.linkedin.com/company/minerva-intelligence-inc' },
        'Category': { select: { name: 'AI Companies' } },
        'City/Region': { rich_text: [{ text: { content: 'Vancouver' } }] },
        'BC Region': { select: { name: 'Lower Mainland' } },
        'Year Founded': { number: 2017 },
        'Size': { select: { name: 'Startup (1-50)' } },
        'Key People': { 
          rich_text: [{ 
            text: { 
              content: 'CEO: Scott Tillman\nFounder: Dr. Clinton Smyth' 
            } 
          }] 
        },
        'Short Blurb': {
          rich_text: [{
            text: {
              content: 'AI knowledge engineering company for mining and climate risk assessment. Public company trading on TSX-V (MVAI), using cognitive AI for mineral exploration and environmental analysis.'
            }
          }]
        },
        'Focus & Notes': {
          rich_text: [{
            text: {
              content: 'Public company (TSX-V: MVAI) | Market cap ~$10M CAD | 11-50 employees | AI-powered knowledge engineering for mining and climate risk'
            }
          }]
        },
        'AI Focus Areas': {
