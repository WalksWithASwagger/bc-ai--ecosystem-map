...
| 3 | **The Builder** | Technical Implementation Specialist | Discovery-Engine Architect | • Crafts search & filter UI<br/>• Live Notion integration<br/>• Next.js data dashboard wizardry | `technical-architecture-specs.md`<br/>`DASHBOARD_PLAN.md`<br/>`ROADMAP.md` | UX brain, dev hands, community heart |
