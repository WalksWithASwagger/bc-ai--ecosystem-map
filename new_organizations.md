# BC AI Ecosystem - New Organizations to Add
...
**Organization Name**: MetaOptima (DermEngine)
...
**Organization Name**: Genesis AI Corp
- **Website**: 
- **LinkedIn**: 
- **City/Region**: Kelowna
- **BC Region**: Interior
...
**Event Name**: Cross Future AI & Technology Summit
- **Date**: Jul 18 2025
...
**Event Name**: Build With AI – UBC GDSC × Launchpad Hackathon
- **Date**: Mar 1 2025
...
## Properties Available in Database:
Based on the current ecosystem map, here are all available properties:

### Core Information:
- Name (title)
- Website, LinkedIn
- City/Region, BC Region
- Email, Phone
- Primary Contact, Key People

### Classification:
- **Category Options**: Start-ups & Scale-ups, Service Studios / Agencies, Enterprise / Corporate Divisions, Investors & Funds, Academic & Research Labs, Government / Public Sector, Non-profit / Community Orgs, Event / Community Orgs, Accelerators / Incubators, Consultants / Freelancers, Tools / Platforms, Media / Content, Industry Associations

- **AI Focus Areas**: Data Science, NLP/LLMs, Computer Vision, MLOps, GenAI, Robotics, CleanTech AI, Healthcare AI, FinTech AI, EdTech AI, AgTech AI, Indigenous AI Applications, Resource Sector AI, Other AI Applications

- **Size Options**: Startup (1-50), Scale-up (51-250), Enterprise (250+), Non-profit/Public

### Relationship Management:
- Status, Opt-In Status, Relationship level
- Last Touch Date, Date Added
- Support Need, Warm-Intro Vector
- Related Organizations

### Content:
- Short Blurb, Focus & Notes
- Notable Projects
- Logo files